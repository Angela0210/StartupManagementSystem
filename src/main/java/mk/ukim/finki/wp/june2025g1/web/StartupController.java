...
public class StartupController {
    ...
    public String listAll( @RequestParam(required = false)String name,
        ...
        model.addAttribute("bodyContent", "startups");
        return "list";
    }
    ...
    public String showAdd(Model model) {
        ...
        model.addAttribute("bodyContent", "startup-form");
        return "form";
    }
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public String create( @RequestParam String name,@RequestParam  Double valuation,
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public String update( @PathVariable Long id,@RequestParam String name,@RequestParam  Double valuation,
                         @RequestParam Integer yearFounded,
                         @RequestParam Industry industry,
                         @RequestParam Long founderId){
